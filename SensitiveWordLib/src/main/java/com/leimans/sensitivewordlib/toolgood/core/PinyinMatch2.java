...
import com.leimans.sensitivewordlib.toolgood.core.internals.BasePinyinMatch;
import com.leimans.sensitivewordlib.toolgood.core.internals.PinyinDict;
import com.leimans.sensitivewordlib.toolgood.core.internals.TwoTuple;
...
public class PinyinMatch2<T> extends BasePinyinMatch {
    ...
    public List<T> Find(String keywords) throws Exception {
        ...
        final List<com.leimans.sensitivewordlib.toolgood.core.internals.TwoTuple<String, String[]>> list = new ArrayList<com.leimans.sensitivewordlib.toolgood.core.internals.TwoTuple<String, String[]>>();
        ...
        for (final T item : _list) {
            ...
            String[] pylist;
            if (_pinyinFunc == null) {
                pylist = com.leimans.sensitivewordlib.toolgood.core.internals.PinyinDict.GetPinyinList(keyword, 0);
            } else {
    ...
    public List<T> FindWithSpace(String keywords) throws Exception {
        ...
        final List<com.leimans.sensitivewordlib.toolgood.core.internals.TwoTuple<String, String[]>> list = new ArrayList<TwoTuple<String, String[]>>();
