...
public class BasePinyinMatch {
    ...
    protected void MergeKeywords(String[] keys, int id, String keyword, List<TwoTuple<String, String[]>> list)
        ...
        if (key.charAt(0) >= 0x3400 && key.charAt(0) <= 0x9fd5) {
            List<String> all = com.leimans.sensitivewordlib.toolgood.core.internals.PinyinDict.GetAllPinyin(key.charAt(0), 0);
    ...
    private static com.leimans.sensitivewordlib.toolgood.core.WordsSearch _wordsSearch;
    ...
    private void InitPinyinSearch() throws NumberFormatException, IOException {
        if (_wordsSearch == null) {
            ...
            com.leimans.sensitivewordlib.toolgood.core.WordsSearch wordsSearch = new WordsSearch();
