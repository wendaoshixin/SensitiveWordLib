...
public class StringMatch extends BaseMatch {
    ...
    private String FindFirst(final String text, final int index, com.leimans.sensitivewordlib.toolgood.core.internals.TrieNode3 ptr) {
    ...
    private void FindAll(final String text, final int index, com.leimans.sensitivewordlib.toolgood.core.internals.TrieNode3 ptr, final List<String> result) {
        for (int i = index; i < text.length(); i++) {
            final char t = text.charAt(i);
            com.leimans.sensitivewordlib.toolgood.core.internals.TrieNode3 tn;
            if (ptr.HasKey(t) == false) {
