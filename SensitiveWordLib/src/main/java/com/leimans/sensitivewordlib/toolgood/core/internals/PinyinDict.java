...
public class PinyinDict {
    ...
    private static com.leimans.sensitivewordlib.toolgood.core.WordsSearch _search;
    ...
    public static String[] GetPinyinList(String text, int tone) throws NumberFormatException, IOException {
        ...
        List<com.leimans.sensitivewordlib.toolgood.core.WordsSearchResult> pos = _search.FindAll(text);
        Integer pindex = -1;
        ...
        if (_pyIndex == null) {
            synchronized(lockObj){
                if (_pyIndex == null) {
                    ...
                    InputStream u1 = com.leimans.sensitivewordlib.toolgood.core.WordsSearch.class.getClassLoader().getResourceAsStream(resourceName);
        ...
        if (_search == null) {
            synchronized(lockObj){
                if (_search == null) {
                    ...
                    br.close();
                    com.leimans.sensitivewordlib.toolgood.core.WordsSearch search = new WordsSearch();
