...
import com.leimans.sensitivewordlib.toolgood.core.internals.Translate;
...
public class WordsHelper {
    ...
    public static String ToTraditionalChinese(String text) throws Exception {
        return com.leimans.sensitivewordlib.toolgood.core.internals.Translate.ToTraditionalChinese(text, 0);
    }
    ...
    public static String ToTraditionalChinese(String text, int type) throws Exception {
        return com.leimans.sensitivewordlib.toolgood.core.internals.Translate.ToTraditionalChinese(text, type);
    }
    ...
    public static String ToSimplifiedChinese(String text) throws Exception {
        return com.leimans.sensitivewordlib.toolgood.core.internals.Translate.ToSimplifiedChinese(text, 0);
    }
