...
import com.leimans.sensitivewordlib.toolgood.core.internals.BaseSearchEx;
...
public class IllegalWordsSearch extends BaseSearchEx {
    ...
    protected void Save(final FileOutputStream bw) throws IOException {
        ...
        bw.write(com.leimans.sensitivewordlib.toolgood.core.NumHelper.serialize(_skipBitArray.length));
        for (final boolean item : _skipBitArray) {
            bw.write(item ? 1 : 0);
        }

        bw.write(UseDuplicateWordFilter ? 1 : 0);
        bw.write(com.leimans.sensitivewordlib.toolgood.core.NumHelper.serialize(_blacklist.length));
        for (final int item : _blacklist) {
            bw.write(com.leimans.sensitivewordlib.toolgood.core.NumHelper.serialize(item));
        }
    ...
    public void Load(final InputStream br) throws IOException {
        ...
        int length = com.leimans.sensitivewordlib.toolgood.core.NumHelper.read(br);
        ...
        length = com.leimans.sensitivewordlib.toolgood.core.NumHelper.read(br);
